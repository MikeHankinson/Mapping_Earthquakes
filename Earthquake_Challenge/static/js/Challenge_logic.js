...
// -----------------------------------
// ESTABLISH TILE LAYORS
// -----------------------------------


// TILE LAYER: STREETS OUTDOORS - We create the tile layer that will be the background of our map.
...
// TILE LAYER:  SATELLITE - We create the second tile layer that will be the background of our map.
...
// DELIVERABLE 3:  ADD A THIRD MAP TILE LAYER
// ...........................................
// TILE LAYER:  LIGHT-V10 
...
let myStyle = {
  ...
  let techtonicPlateBoundary = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
  
  // Grab GeoJSON data.
  d3.json(techtonicPlateBoundary).then(function(data) {
    console.log(data);
...
// d3 tech 
    ...
    // Add TECHTONIC PLATES layer to Map
    techtonicPlates.addTo(map);
